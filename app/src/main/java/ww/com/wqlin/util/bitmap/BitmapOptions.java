package ww.com.wqlin.util.bitmap;
...
import ww.com.wqlin.view.RoundBorderBitmapDisplayer;
...
public class BitmapOptions {
    ...
    public static DisplayImageOptions getRoundBorderOpt(int radius,int borderColor,int borderWidth) {
        return BitmapOptions.getDisplayImageBuilder(R.drawable.image_default).displayer(new RoundBorderBitmapDisplayer(radius,borderColor,borderWidth)).build();
    }
    public static DisplayImageOptions getRoundBorderOpt(int defaultImg,int radius,int borderColor,int borderWidth) {
        return BitmapOptions.getDisplayImageBuilder(defaultImg).displayer(new RoundBorderBitmapDisplayer(radius,borderColor,borderWidth)).build();
    }
